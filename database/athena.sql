...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-04-2026 a las 14:53:07
...
--
-- Volcado de datos para la tabla `detalle_entrenamiento`
--

INSERT INTO `detalle_entrenamiento` (`id_detalle`, `id_entrenamiento`, `ejercicio`, `series`, `repeticiones`, `peso`) VALUES
(1, 1, 'Dominadas', 5, 8, NULL),
(2, 1, 'Peso muerto', 4, 10, 50.00),
(3, 1, 'Sentadillas', 4, 12, 50.00),
(4, 1, 'Push up', 5, 10, NULL),
(5, 2, 'jumping jacks', 5, 40, NULL),
(6, 2, 'saltos al cajon', 5, 20, NULL),
(7, 2, 'wall ball', 5, 20, NULL),
(8, 2, 'burpees', 5, 15, NULL),
(9, 3, 'burpees', 4, 15, NULL),
(10, 3, 'push up', 4, 20, NULL);
...
CREATE TABLE `entrenamiento` (
  ...
  `estado` enum('Programado','Completado') NOT NULL DEFAULT 'Programado',
...
INSERT INTO `entrenamiento` (`id_entrenamiento`, `id_usuario`, `fecha`, `duracion_minutos`, `estado`, `observaciones`) VALUES
(1, 3, '2026-04-21', 45, 'Completado', 'full body'),
(2, 2, '2026-04-30', 30, 'Programado', 'Hiit'),
(3, 3, '2026-04-27', 14, 'Programado', 'hiit');
...
INSERT INTO `notificacion` (`id_notificacion`, `titulo`, `mensaje`, `tipo`, `destinatario_tipo`, `fecha_envio`) VALUES
(1, 'Mejoras en sección entrenamientos', 'Hemos mejorado nuestro apartado de entrenamientos para que saques aún más partido a tu experiencia en el gimnasio.\r\n\r\nAhora puedes registrar tus entrenamientos de forma sencilla, hacer un seguimiento completo de tu actividad y visualizar tu progreso a lo largo del tiempo.\r\n\r\nEmpieza hoy mismo y lleva tu evolución al siguiente nivel', 'General', 'Todos', '2026-04-21 11:08:44'),
(2, 'prueba', 'esto es una prueba', 'General', 'Todos', '2026-04-21 12:59:48'),
(3, 'prueba', 'esto es otra prueba', 'General', 'Todos', '2026-04-21 13:09:44');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `objetivo_entrenamiento_semanal`
--

CREATE TABLE `objetivo_entrenamiento_semanal` (
  `id_objetivo_semanal` int(11) NOT NULL,
  `id_usuario` int(11) NOT NULL,
  `semana` int(11) NOT NULL,
  `anio` int(11) NOT NULL,
  `objetivo_total` int(11) NOT NULL DEFAULT 4
) ;

--
-- Volcado de datos para la tabla `objetivo_entrenamiento_semanal`
--

INSERT INTO `objetivo_entrenamiento_semanal` (`id_objetivo_semanal`, `id_usuario`, `semana`, `anio`, `objetivo_total`) VALUES
(1, 3, 17, 2026, 4),
(2, 2, 17, 2026, 5),
(3, 3, 18, 2026, 4);
...
INSERT INTO `reserva` (`id_reserva`, `id_usuario`, `id_sesion`, `fecha_reserva`, `estado`) VALUES
(1, 2, 2, '2026-04-10 14:42:38', 'Asistida'),
(2, 2, 3, '2026-04-10 14:44:31', 'Asistida'),
(4, 2, 54, '2026-04-15 09:31:00', 'Asistida'),
(5, 2, 58, '2026-04-15 10:38:45', 'Asistida'),
(6, 2, 59, '2026-04-15 11:43:48', 'Asistida'),
(7, 2, 60, '2026-04-15 11:53:10', 'No asistida'),
(8, 2, 61, '2026-04-15 12:45:47', 'Asistida'),
(9, 2, 51, '2026-04-15 13:09:20', 'Asistida'),
(10, 3, 62, '2026-04-15 17:31:51', 'Asistida'),
(11, 3, 63, '2026-04-15 17:32:01', 'Asistida'),
(12, 3, 64, '2026-04-23 21:21:37', 'Confirmada'),
(13, 2, 65, '2026-04-24 19:29:28', 'No asistida'),
(14, 2, 66, '2026-04-27 13:38:45', 'Confirmada'),
(15, 2, 67, '2026-04-27 13:38:48', 'Confirmada'),
(16, 2, 68, '2026-04-27 13:39:07', 'Asistida'),
(17, 2, 69, '2026-04-27 13:39:29', 'Confirmada'),
(18, 3, 70, '2026-04-27 14:21:16', 'Confirmada'),
(19, 3, 71, '2026-04-27 14:21:17', 'Confirmada'),
(20, 3, 72, '2026-04-27 14:21:22', 'Confirmada'),
(21, 3, 73, '2026-04-27 14:21:27', 'Confirmada'),
(22, 3, 74, '2026-04-27 14:21:31', 'Confirmada'),
(23, 3, 75, '2026-04-27 14:21:38', 'Confirmada'),
(24, 3, 76, '2026-04-27 14:21:44', 'Confirmada'),
(25, 3, 77, '2026-04-27 14:21:45', 'Confirmada'),
(26, 3, 78, '2026-04-27 14:21:47', 'Asistida');
...
(58, 7, '2026-04-19', NULL, 18, 'Programada'),
(59, 30, '2026-04-21', NULL, 8, 'Programada'),
(60, 11, '2026-04-16', NULL, 22, 'Programada'),
(61, 45, '2026-04-15', NULL, 18, 'Programada'),
(62, 12, '2026-04-17', NULL, 24, 'Programada'),
(63, 63, '2026-04-15', NULL, 20, 'Programada'),
(64, 16, '2026-04-28', NULL, 18, 'Programada'),
(65, 7, '2026-04-26', NULL, 18, 'Programada'),
(66, 12, '2026-05-08', NULL, 24, 'Programada'),
(67, 17, '2026-05-06', NULL, 18, 'Programada'),
(68, 14, '2026-05-24', NULL, 18, 'Programada'),
(69, 54, '2026-05-23', NULL, 22, 'Programada'),
(70, 1, '2026-05-11', NULL, 20, 'Programada'),
(71, 2, '2026-05-12', NULL, 22, 'Programada'),
(72, 14, '2026-05-10', NULL, 18, 'Programada'),
(73, 9, '2026-04-28', NULL, 22, 'Programada'),
(74, 67, '2026-04-27', NULL, 25, 'Programada'),
(75, 36, '2026-05-18', NULL, 18, 'Programada'),
(76, 6, '2026-05-23', NULL, 25, 'Programada'),
(77, 12, '2026-05-22', NULL, 24, 'Programada'),
(78, 21, '2026-05-24', NULL, 25, 'Programada');
...
(1, 2, 3, '2026-04-07', '2026-05-27', NULL, 1, 'Activa'),
(2, 3, 4, '2026-04-08', '2026-05-27', NULL, 1, 'Activa');
...
(2, 'Usuario1', 'Lorena', 'A', '1997-04-02', '12378945A', '612378945', 'usuario1@athena.com', '$2y$10$l9DUf2cUEYHxXnQ0mwctteJn.V8BKAAAVIewrATO41.gFmUTW.Qm2', 'Mujer', 'Activo', '../img-socios/socio1.png', '2026-04-07 17:41:18', 1, 2),
(3, 'Usuario2', 'Luis', 'SPL', '1990-04-14', '78912345B', '678912345', 'usuario2@athena.com', '$2y$10$Qqe7Uo4M8ZTKRH96xoi6xOrqE.lCnCTbuXLL6KHrbqUPC2bNxw45u', 'Hombre', 'Activo', '../img-socios/usuario2opcion2.png', '2026-04-08 09:13:50', 2, 2);
...
INSERT INTO `usuario_notificacion` (`id_usuario_notificacion`, `id_usuario`, `id_notificacion`, `leida`, `fecha_lectura`) VALUES
(1, 2, 1, 1, '2026-04-21 13:00:23'),
(2, 3, 1, 0, NULL),
(3, 2, 2, 1, '2026-04-21 13:00:14'),
(4, 3, 2, 1, '2026-04-23 21:22:57'),
(5, 2, 3, 0, NULL),
(6, 3, 3, 0, NULL);
...
--
-- Indices de la tabla `objetivo_entrenamiento_semanal`
--
ALTER TABLE `objetivo_entrenamiento_semanal`
  ADD PRIMARY KEY (`id_objetivo_semanal`),
  ADD UNIQUE KEY `uq_objetivo_usuario_semana` (`id_usuario`,`semana`,`anio`);
...
--
-- AUTO_INCREMENT de la tabla `objetivo_entrenamiento_semanal`
--
ALTER TABLE `objetivo_entrenamiento_semanal`
  MODIFY `id_objetivo_semanal` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `usuario_notificacion`
  MODIFY `id_usuario_notificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- Filtros para la tabla `objetivo_entrenamiento_semanal`
--
ALTER TABLE `objetivo_entrenamiento_semanal`
  ADD CONSTRAINT `fk_objetivo_semanal_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE;
